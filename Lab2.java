public class Lab2 {
	...
	double d = (double) numSacksPerWife;
	
	int numCatsPerSack = 7;

	int numKitsPerCat = 7;
	long i = (long) numKitsPerCat;
	...
	int totalGoing = numKitsPerCat + numCatsPerSack + numSacksPerWife + numWives;
	...
	System.out.println("The Number going to St. Ives is " + totalGoing);
